...
**Exact imported production authority:** ✅ `b594ba82afbbefb8cc5c27ea2604d9f308392daa` for readiness, Pages artifact, successful Pages deployment, live pointer/run-addressed provenance and TTS capability witness.
**Current source deployment status:** ⚠️ `9407cc92` is newer than the imported production witness and is **not** claimed deployed.
**Current source reverify:** `reverify/CURRENT_HEAD_REVERIFY_2026-07-26_9407cc92_genesis-b594-production.md`
...
- exact production authority is `b594ba82`: readiness `30176319427`, deploy `30176621679`, Pages artifact `8624531252` (`sha256:5d634570ba74435aea54b2176086822262efb2d45f10ec662b7b9bd6b715e9a4`) and TTS artifact `8624532125` (`sha256:9d7dcbedd75825acc4ffa6da8fa174697bbccbdee2d5b8158fdd967490fb8bb5`); live pointer and immutable provenance both bind `b594ba82` to deploy `30176621679` attempt 1 and readiness `30176319427`;
...
- exact #348 head `ce75fcde` passed Genesis 6 Research provenance `30176399705`, Shared Files Guard `30176399710` and Visual Parity `30176399701`; post-merge Genesis run `30177457077` passed on `9407cc92` with artifact `8624610690` (`sha256:527d55f98e33c4ff0c57cc8b27fd669fd2002030304429889577c8d1333396cd`);
...
- no exact readiness/Pages/live witness for source `9407cc92` is imported; the exact production witness remains the preceding commit `b594ba82`;
...
- **#365 — homepage lifecycle evidence owner (supersedes closed staging #361):** test-only extension of the existing Runtime Interactive Audit; owns `.github/workflows/interactive-audit.yml` and `scripts/home-browser-lifecycle-contract.mjs` only;
...
- #338 closes the broad homepage browser-contract issue #299; #365 owns only residual lifecycle/shortcut evidence and must not redesign the homepage;
...
PR #338 permanently covers the broad homepage Chromium/WebKit/no-JS behavior. Historical run `30175901907` attempt 1 failed only WebKit Ctrl+K focus; unchanged attempt 2 passed all four modes, uploaded artifact `8624672432` (`sha256:2d45251b…`) and notifier issue #357 closed automatically. PR #365 remains the sole owner of the separate real-history/lifecycle/shortcut residual in the existing workflow. PRs #324/#336/#346 guarantee per-hop source-link policy, DNS validation/request pinning, evidence secrecy, bounded response handling and fail-closed systemic detection.

### Deployment witness projection and concurrency

PRs #312/#332 keep Pages deploy read-only, isolate write permissions, canonicalize deploy-run aliases before locking and permanently mutation-test replay/artifact/supply-chain boundaries. Automatic deploy `30176621679` produced Pages artifact `8624531252`, live pointer/run provenance for `b594ba82` and TTS witness artifact `8624532125`. This is capability evidence, not whole-artifact readiness→deploy identity. Replay `30171194731` is successful; historical run `30169981463` remains failure.
...
1. **Finish exact owner #365 without crossing product files**
...
2. **Create one fresh Genesis 6 product-finalizer owner**
   - start from current source main after refreshing #365 status;
