...
**Раздел карт /karty/ — глубокий аудит (2026-07-19, c2c339708252): 31 баг в матрице (8 P0 + 20 P1 + 3 P2).** Подтверждённые P0 в `MapEngine v0.53`: **MAP-P0-01** (мобильная панель уходит выше экрана до -581px), **MAP-P0-02** (Share crash `getState is not defined`), **MAP-P0-03** (Search crash `inStory is not defined` + opacity reset), **MAP-P0-04** (перетирание `viewport_init` безусловным flyTo), **MAP-P0-05** (игнорирование query/hash deep links), **MAP-P0-06** (no-op layer toggles `[data-layer="{id}"]`), **MAP-P0-07** (тёмная тема хардкод), **MAP-P0-08** (zoom click/keyboard bypass). Восемь holding-карт правильно скрыты и не готовы к публикации до ликвидации P0/P1 дефектов. **Парадигма владельца (ВАРИАНТ 1):** карта должна быть красивой географической SVG-картой Ближнего Востока (пергамент, рельеф, синяя акватория, иконки мест), а НЕ простой «картой-схемой» на чёрном фоне. Evidence: `incoming/arena-auditor-karty-verification/2026-07-19/EVIDENCE_PARADIGM_AND_SVG_BASEMAP_AUDIT_2026-07-19.md`.
