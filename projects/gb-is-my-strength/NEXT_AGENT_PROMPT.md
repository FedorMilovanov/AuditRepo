...
- ReaderProjection squash merge retained: `92c4939c62bda365c1531c31d150c3988d8cfa47` (PR #990).
...
- Product PR #1061 exact tested head `845ad48409fc3c8a2fa7056f4b84e005e652318e` passed **25/25** applicable workflow groups before guarded squash merge `d0647b71b557c17e408c09712fcd8c3ab05ba257`.
- Favorite Store run `31037316037`, job `92412574991`: exact identity PASS, source **65/65**, Chromium **138/138** across Hermenevtika, Gill, Antisovetov, Home cross-tab and `/izbrannoe/`, with zero page errors.
...
- Production authority remains run `30960174778` attempt `1` on `38b257030afb7cfa8a7b1128f8c86539fd36dec0`; neither ReaderProjection nor Favorite Store source closure changes that authority.
