> **Restored file.** This is the original intake report merged as `README.md` in PR #336 and overwritten by PR #339 (which replaced the body with a folder index). Content below is byte-identical to `935fe31`; nothing was rewritten. The parallel pass keeps its own `REPORT.md`; both evidence packages are preserved.
