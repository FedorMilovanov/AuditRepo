...
3. **Структура проекта хорошо организована** — чёткое разделение компонентов, скриптов, данных
4. **CI/CD pipeline работает** — деплой автоматизирован, есть проверки
5. **Документация существует** — AGENTS.md описывает архитектуру и правила
