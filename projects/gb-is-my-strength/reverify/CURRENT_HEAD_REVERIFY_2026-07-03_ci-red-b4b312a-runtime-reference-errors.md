...
## 9. Current-head refresh — `dbd0bb55` (2026-07-03)
...
Public GitHub Actions API shows the new current deploy is still red:
...
Fresh local reverify on `dbd0bb55ce...` confirms the previous runtime blocker remains current:
