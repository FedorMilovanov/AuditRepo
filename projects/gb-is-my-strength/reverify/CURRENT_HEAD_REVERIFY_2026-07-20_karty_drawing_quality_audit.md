...
| **Cartouche, Waves & Compass** | **FAILED (WEAK)** | 2 P1 (`SEA-P1-01`, `ORN-P1-01`), 1 P1 (`COMP-P1-01`) | 20px repeating tile grid creates "bathroom tile" sea patterns; 3-line cartouche corners; magic float cartouche width formulas (`length * 14.6`); modern Russian letter `С` on compass; HUD scale ratio error up to 22% |
