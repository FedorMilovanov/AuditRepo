# CURRENT HEAD REVERIFY — source `2f9ad5d8` vs production `abf1edba`

**Дата:** 2026-08-01  
**Статус:** `SOURCE_CURRENT / PRODUCTION_STALE_RELATIVE_TO_SOURCE`  
**Production claim для `2f9ad5d8`:** `no`
...
- На момент этой сверки открытых source PR нет; PR #667 уже слит и входит в current source.
...
- PR #668 — active README architecture corrected from Astro 6 to Astro 7, exact head `a1d590869131fb6a94bc73ae613cabb41459117d`, merge `b4b02f72c26f5ac9c58ea9efe11cfcf4fa3d2c19`, Shared Files Guard and Metadata & IndexNow green;
- PR #667 — Pagefind scripture/noindex/RSS follow-ups, exact head `8eaf822bca32e1f7be332c2b323a2dba5ff60dd4`, merge/current source `2f9ad5d89143fd45be1b882219eadfc89bfbdbae`, 9/9 triggered workflows green, review threads 0;
...
До этого момента нельзя писать `SOURCE = PRODUCTION`, объявлять `2f9ad5d8` deployed или переносить старые live-доказательства на новый HEAD.
...
- включает слитый PR #667 в source ancestry;
