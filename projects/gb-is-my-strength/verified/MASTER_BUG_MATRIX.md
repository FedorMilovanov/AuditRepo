...
| Поле | Значение |
|---|---|
| Source HEAD | `cd4b77068fabfde05487859f2178ea89ad9b2e43` (current source main; #405 homepage lifecycle capability contract, #397 dormant Genesis manuscript theme, #374 effective workflow permission registry and #370 build-once exact-candidate release merged; no source PR open at capture) |
| Deploy | ✅ **SOURCE = PRODUCTION AUTHORITY.** Exact run `30211404138` attempt 1 built one immutable candidate from `cd4b77068fabfde05487859f2178ea89ad9b2e43`, promoted the same bytes without checkout/rebuild, passed generic and TTS live acceptance and wrote the downstream release ledger. Candidate artifact `8634711632` (`sha256:577aa82418448aa77199f9a9ac928e5836dee716a2a3624c6ee7a0a6996cc5c3`), tree `sha256:0f1780b179b6dce95dbebb8427a3e44441709d03c3a576afa1234fe86681b1a4`, Pages artifact `8634714712` (`sha256:cc66d911666ab7536fb04b62a4c1e2fb8521b4d5a1b46e55dce15eb3d37f1750`), generic live `8634715957` (`sha256:f669aecd843e0d661dd66a0b4e4ca39ec9e2a14120ade63762ef6fab288ab8fc`), TTS `8634716211` (`sha256:78cf2c0daaaf21790316f8d36e8f5c7585b45540f81c2da79c89e944c20ce413`). |
...
| Last reverify | `reverify/CURRENT_HEAD_REVERIFY_2026-07-26_cd4b7706_build-once-production.md` |

⚠️ Старые deploy-формулировки ниже исторические. Current source and exact production authority are both `cd4b77068fabfde05487859f2178ea89ad9b2e43`. PR #370 closes whole-release identity/build-once with exact production and ledger evidence; PR #405 closes the homepage lifecycle residual. Genesis route activation remains open under issue #362 and `draft-noindex` is unchanged. Evidence: `reverify/CURRENT_HEAD_REVERIFY_2026-07-26_cd4b7706_build-once-production.md`.
...
| AUDIT-PRODUCTION-EVIDENCE-IMPORT-GAP | ✅ **FIXED/EXACT PRODUCTION+LEDGER IMPORTED 2026-07-26.** Current source and production authority converge at `cd4b77068fabfde05487859f2178ea89ad9b2e43`. Run `30211404138` attempt 1 produced candidate `8634711632` (`sha256:577aa82418448aa77199f9a9ac928e5836dee716a2a3624c6ee7a0a6996cc5c3`), Pages artifact `8634714712`, generic live `8634715957` and TTS `8634716211`; downstream ledger comment `5084526211` accepted both SHAs, candidate tree and all artifact identities. This does not activate Genesis routes; issue #362 remains separate. | `cd4b7706` production run `30211404138` |
...
| AUDIT-SSOT-CURRENT-HEAD-DRIFT | ✅ **FIXED/RECONCILED AGAIN 2026-07-26.** Operational SSOT records source and production authority `cd4b77068fabfde05487859f2178ea89ad9b2e43`, build-once deploy run `30211404138`, candidate/generic/TTS artifacts and downstream ledger; it also records closed homepage residual #405, closed permission registry #374 and sole Genesis owner issue #362. Immutable prior reverifies remain unchanged. | `cd4b7706` source+production import |
...
## Статистика (обновлено 2026-07-26: source = production `cd4b7706`; build-once + homepage residual closed)
