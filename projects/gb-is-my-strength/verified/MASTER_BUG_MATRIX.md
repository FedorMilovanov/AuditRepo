...
| Поле | Значение |
|---|---|
| Source HEAD | `6c4106aecd35a3c95b09b041332d653f581ceb92` (main; Hard Texts native visual ownership plus Nagornaya source-role registry/argument layers landed) |
| Deploy | ✅ **PRODUCTION VERIFIED @ `6c4106ae`.** Exact main checks: Shared `29950458595`, Visual `29950458386`, Native `29950458319`, readiness `29950459817`; readiness created Pages `29951046722` for the same SHA. Pre-merge Route Registry/browser `29949641685` recorded 3428/3428 PASS and `/nagornaya/istochniki/` 33/33. AuditRepo witness `29950695954` / artifact `8542524012` verified registry 3 sources/6 claims and live HTTP 200 with 8/8 required, 2/2 stale absent; live SHA-256 `b430cdc33e6245e2dc024e8c8802bb5e487bc19a862aee2601c122c72df3f561`. |
...
⚠️ Старые deploy-формулировки ниже исторические. Текущий authority — `reverify/CURRENT_HEAD_REVERIFY_2026-07-22_6c4106ae_source-registry-production.md`; exact production deployment доказана readiness `29950459817` → Pages `29951046722` на `6c4106ae`, live/registry witness `29950695954`.
