...
> **Source HEAD: `3280445` (fix pushed for D-23) — НЗ на `36b815c2` не deploy-green: run `28827343079` FAILURE (2026-07-06T22:23Z, Gill play-smoke). Продакшн был ЗАПЕРТ на последнем GREEN run `28794737410` @ `14a49be8` (2026-07-06T13:22Z); фикс запушен `3280445` (run `28829589012` in-progress) — см. D-23.**  
> Обновлено: **2026-07-06** (+D-23 fix pushed `3280445`, CI verification in progress) (fable-super-audit: единый HEAD, D-строки arena влиты в канонические таблицы, счётчики пересобраны).  
