...
| NG-DARK-04 | ✅ **DUPLICATE / MERGED INTO `NG-DARK-01` 2026-08-04; CURRENT WORDING RECONCILED.** This row remains closed because `bg-rose-50` never defined an independent repair lane. Exact Product `f9d0120718569c510833dba7a3abd68ce2f6a003` reverify now shows the token is covered on every current using route by linked dark CSS, so the former sentence that current source lacks this remap is retired and does not support the remaining root residual. No Product mutation, browser, production or TTS claim. | `f9d01207` source reverify |
| NG-DARK-05 | ✅ **DUPLICATE / MERGED INTO `NG-DARK-01` 2026-08-04; CURRENT WORDING RECONCILED.** The aggregate stone-background row remains closed and is not reopened as a second owner. Exact Product `f9d0120718569c510833dba7a3abd68ce2f6a003` proves body `bg-stone-100` is covered by linked dark CSS; any stone token still lacking complete coverage is recorded only in the generated current residual of open `NG-DARK-01`. No Product mutation, browser, production or TTS claim. | `f9d01207` source reverify |
