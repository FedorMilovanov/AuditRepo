...
| BASE-P1-01 | 🆕 **Karty P1:** Пустой `<defs>` в базовых векторных географиях `base-geo.svg`, `base-geo-mediterranean.svg`, `base-geo-urheimat.svg` (битые ссылки `fill="url(#landG)"`, `fill="url(#desertG)"`) | verified-source (32ae0d7d) |
...
| BASE-P1-04 | 🆕 **Karty P1:** 18 отсутствующих ID-линковок в `base-geo.svg`, включая символы гор (`#hill`, `#peak`, `#peak-snow`, `#canaanRidge`) | verified-source (32ae0d7d) |
...
| GRAT-P1-01 | 🆕 **Karty P1:** Линейные непроекционные уравнения координатной сетки (`sheet-engine.js:437`) создают прямоугольные искажения и не рисуют линий меридианов по полю карты | verified-source (32ae0d7d) |
...
| ORN-P1-01 | 🆕 **Karty P1:** Угловая виньетка рамки `#cornerOrn` в `sheet-engine.js:98` состоит из 3 элементарных линий, уступая историческим гравюрным картушам | verified-source (32ae0d7d) |
...
| CART-P1-01 | 🆕 **Karty P1:** Вычисление ширины картуша заголовка по формуле с магическими коэффициентами (`length * 14.6`) вызывает обрезку длинных названий карт | verified-source (32ae0d7d) |
| ROSE-P1-01 | 🆕 **Karty P1:** Использование современной русской буквы «С» в классической розе ветров (`sheet-engine.js:731`) диссонирует со старинным гравюрным стилем | verified-source (32ae0d7d) |
...
| GRAT-P1-02 | 🆕 **Karty P1:** Засечки градусной сетки полностью скрываются (`opacity: 0`), как только карта приближается более чем на 4% | verified-source (32ae0d7d) |
...
## Статистика (обновлено 2026-07-19: глубокий аудит раздела карт /karty/ +83 открытых багов: 15 P0 + 61 P1 + 11 P2)
