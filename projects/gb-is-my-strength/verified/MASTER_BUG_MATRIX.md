...
| Поле | Значение |
|---|---|
| Source HEAD | `7a410be9` (main; PR#67 Gill Часть IV «Экзегет» + rail, PR#68 rail-CSS-scope hotfix, PR#69 mobile-play smoke hotfix) |
| Deploy | ✅ **GREEN** — `deploy.yml` run `29058726462` @ `7a410be9`, все шаги success (2026-07-09T23:57Z). Два deploy-блокера этой сессии починены: scope-leak (PR#68) + устаревшие smoke-константы (PR#69). |
