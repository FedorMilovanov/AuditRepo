...
- Count impact after pass 3: P1 `70 → 73`, P2 `29 → 31`, total open `145 → 150`, closed unchanged `213`, total IDs `358 → 363`. No Product mutation, same-SHA production claim or browser pixel claim.
