...
| Поле | Значение |
|---|---|
| Source HEAD | `32ae0d7d62bee81737a9aae1f136946d047fe4fb` (main; genealogy atlas уже на 256 этимологиях, karty deep-audit и book-mode серии «Сердце» на этом HEAD) |
| Deploy | 🔴 **RED / STALE (reverified 2026-07-20)** — last GREEN: `007b67def5` (run `29138555390`, 2026-07-11T03:46:58Z). Current HEAD deploy run `29621961761` FAIL на шаге **Static publication gates**. Локальное воспроизведение на current HEAD: `npm run validate:static-publication` падает в `audit-pro.js` на oversized raw atlas-export PNG (`images/atlas-export/shvatim-hires.png`, `images/atlas-export/shvatim-preview.png`). |
...
| Last reverify | `reverify/CURRENT_HEAD_REVERIFY_2026-07-20_32ae0d7d.md` |

⚠️ Часть строк в старом P0 deploy-блоке ниже всё ещё несёт 2026-07-14-формулировки. Текущий авторитет по live deploy-stop-point — `reverify/CURRENT_HEAD_REVERIFY_2026-07-20_32ae0d7d.md` + мастхед этой матрицы; исторические строки требуют отдельной уборки без потери provenance.
