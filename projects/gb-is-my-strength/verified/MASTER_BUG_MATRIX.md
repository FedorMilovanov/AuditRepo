...
| Поле | Значение |
|---|---|
| Source HEAD | `9407cc92eb22dc6eab76f831df35a09429663e3e` (current source main; #336/#346 trustworthy source-link acceptance, #338 homepage Chromium/WebKit contract, #354 Gill source repair and #348 exact Genesis 6 Research provenance merged; active source owner at capture: #365 homepage lifecycle evidence) |
| Deploy | ⚠️ **SEPARATE AUTHORITIES.** Exact Pages/live/TTS production authority is `b594ba82`: readiness `30176319427`, deploy `30176621679`, Pages artifact `8624531252` (`sha256:5d634570…`), TTS witness artifact `8624532125` (`sha256:9d7dcb…`), successful Pages deployment, live `current.json` and run-addressed provenance. Current source `9407cc92` is newer and not claimed deployed. Historical ledger run `30169981463` remains failure; trusted manual replay `30171194731` is a separate later success. Whole-release identity/build-once remain #292/#295. |
...
| Last reverify | `reverify/CURRENT_HEAD_REVERIFY_2026-07-26_9407cc92_genesis-b594-production.md` |

⚠️ Старые deploy-формулировки ниже исторические. Current source authority: `9407cc92`; exact Pages/live/TTS production authority: `b594ba82`. PR #348 closes the Research authority/provenance gap while preserving `draft-noindex`; it does not activate Genesis 6 routes. Source `9407cc92` is not claimed deployed; Genesis product activation and whole-release identity/build-once remain open. Evidence: `reverify/CURRENT_HEAD_REVERIFY_2026-07-26_9407cc92_genesis-b594-production.md`.
...
| AUDIT-SSOT-CURRENT-HEAD-DRIFT | ✅ **FIXED/RECONCILED AGAIN 2026-07-26.** Operational SSOT records source `main@9407cc92`, exact deployed Pages/live/TTS authority `b594ba82`, successful trusted replay `30171194731`, merged #336/#346/#338/#354/#348 and active test-only owner #365. It separates Research provenance, Genesis product activation, homepage lifecycle evidence, source deployment and production authority. Immutable prior reverifies remain unchanged. | `9407cc92` source + exact `b594ba82` production import |
...
| ID | Описание | Witnesses |
|---|---|---|
| HOME-BROWSER-LIFECYCLE-RESIDUAL | **P1 evidence residual after #338.** Reopened issue #299 requires real same-origin `/ → /about/ → Back` BFCache traversal, persisted lifecycle cleanup, exactly one post-restore menu transition, stable theme state, independent canonical Meta+K, editable/contenteditable/IME isolation and back-to-top threshold behavior in Chromium and WebKit. PR #365 is the sole owner and may change only the existing interactive-audit workflow plus one permanent lifecycle contract script. | issue #299 reopened; PR #365 |
...
| AUDIT-PRODUCTION-EVIDENCE-IMPORT-GAP | ✅ Exact readiness, Pages deployment, Pages/TTS artifacts, live pointer and run-addressed provenance are imported for `b594ba82`: readiness `30176319427`, deploy `30176621679`, Pages artifact `8624531252` and TTS artifact `8624532125`. Current source `9407cc92` remains newer and undeployed. Residual gap is generic whole-release digest/build-once under #292/#295; Genesis provenance CI does not imply publication activation or deployment. | source `9407cc92`; production `b594ba82`; `reverify/CURRENT_HEAD_REVERIFY_2026-07-26_9407cc92_genesis-b594-production.md` |
...
## Статистика (обновлено 2026-07-26: source 9407cc92 + exact b594ba82 production import)
