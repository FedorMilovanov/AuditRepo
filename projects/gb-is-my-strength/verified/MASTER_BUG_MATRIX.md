...
| Поле | Значение |
|---|---|
| Source HEAD | `b8459bdf` (main; PR#67 Gill Часть IV «Экзегет» + rail, PR#68/#69 deploy hotfixes, PR#70 CI-INDEXNOW fix, PR#71 sibling-grid propagation) |
| Deploy | ✅ **GREEN** — `deploy.yml` run `29065454930` @ `b8459bdf`, все шаги success (0 failed). Ранее: `29058726462`@7a410be9 ✅, `29064586092`@3a43cada ✅. |
