...
## Статистика (обновлено 2026-07-14 live-reverify @ `2ca2af3b`, 2 прохода: +1 закрыто source [CI-INDEXNOW-CHECKER-STALE @ 3a43cada] + AR-CI-RED закрыт в AuditRepo; +6 deploy-блокеров [3×P1 REG-*/CACHE-BUST + P2 GATE-CSS-IMPORTANT-RATCHET + 2×P3 AUDIT-ATLAS-DOC-PATH-LEAK/AUDIT-FORBIDDEN-JS-NAGORNAYA])
...
| Рефакторинг | 4 |
| AuditRepo | 3 |
| **Всего открыто (матрица)** | **49** |
| Системный бэклог вне матрицы | см. `SUPER_AUDIT_2026-07-06_14a49be8.md` (волны W1–W10) |
| False positives отклонено | 5 |
| Passes processed | 97+ (live-reverify 2026-07-14 @ 2ca2af3b ×2 прохода + AR-CI-RED, arena-auditor-meta-governance) |
