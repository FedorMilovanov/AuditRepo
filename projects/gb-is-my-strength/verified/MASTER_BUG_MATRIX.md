...
| Поле | Значение |
|---|---|
| Source HEAD | `ca8c8130a1ec7d9b12cc14e9274fe2ba855076a1` (current source main; PR #624 added the bounded A04 tooltip/Bible ownership contract and route-wide witnesses; Node 22.23.1/npm 10.9.8 remains inherited; premium homepage closure remains in ancestry; active independent lanes remain separately owned) |
| Deploy | ✅ **SOURCE = PRODUCTION AUTHORITY.** Exact run `30651535224` attempt `1` built and promoted candidate `ca8c8130a1ec7d9b12cc14e9274fe2ba855076a1:30651535224-1` from `ca8c8130a1ec7d9b12cc14e9274fe2ba855076a1`; live pointer and immutable manifest match digest `sha256:ed25db05618922ab271e85ff883ac965388c39d4c99eb66d38051916a56c7942`. Candidate artifact `8802022675` (`sha256:629e3f7c8dc0140219406f258a401aeb3c1bae33045f70afa8a88d9c0e385ead`), generic live `8802032844` (`sha256:a99e9627f1a6480cdf76924d64f53a21d075dbe1dc7af30ab02b3dded171887a`), TTS `8802033419` (`sha256:112b0235b525a77bae118ffc38533f60e863dc2f0a2c0016612c2843a3387072`). Source ledger comment `5145907989`. |
...
| Last reverify | `reverify/CURRENT_HEAD_REVERIFY_2026-07-31_ca8c8130_exact-production-home-closure.md` |

⚠️ Deploy-формулировки в исторических строках ниже сохраняют состояние соответствующей даты. Текущие source и exact production authority совпадают на `ca8c8130a1ec7d9b12cc14e9274fe2ba855076a1`: run `30651535224` attempt `1`, candidate `ca8c8130a1ec7d9b12cc14e9274fe2ba855076a1:30651535224-1`, live/TTS PASS. Главная `/` завершена в текущей ancestry; Astro 7 and Pixelmatch remain separate active lanes; A04 PR #624 and Baptist research PR #625 are already in current ancestry. Evidence: `reverify/CURRENT_HEAD_REVERIFY_2026-07-31_ca8c8130_exact-production-home-closure.md`.
...
| AUDIT-PRODUCTION-EVIDENCE-IMPORT-GAP | ✅ **FIXED/EXACT PRODUCTION+LEDGER RECONCILED 2026-07-31.** Source, release, control plane, live pointer and immutable manifest converge at `ca8c8130a1ec7d9b12cc14e9274fe2ba855076a1`. Run `30651535224` attempt `1` published candidate `ca8c8130a1ec7d9b12cc14e9274fe2ba855076a1:30651535224-1` / `sha256:ed25db05618922ab271e85ff883ac965388c39d4c99eb66d38051916a56c7942`; generic and TTS live artifacts passed and source PR #624 received machine ledger comment `5145907989`. A later source merge requires a new current-head witness but does not invalidate this immutable release record. | `ca8c8130` production run `30651535224` |
...
| AUDIT-SSOT-CURRENT-HEAD-DRIFT | ✅ **FIXED/RECONCILED 2026-07-31.** Operational SSOT records exact source/production authority `ca8c8130a1ec7d9b12cc14e9274fe2ba855076a1`, deploy run `30651535224`, candidate/live/TTS identities, completed homepage closure and protected ownership of active independent lanes. AuditRepo synchronization PR #108 changes no source product code and leaves counters unchanged. | `ca8c8130` source+production import |
...
## Статистика (обновлено 2026-07-31: source = production `ca8c8130`; homepage/current-head exact release reconciled)
...
- **2026-07-31 — source/production convergence `ca8c8130` and homepage closure reconciliation** — PR #624 merged the bounded A04 ownership/runtime witness and nested-glossary policy fix on the inherited Node 22.23.1/npm 10.9.8 main without changing the completed premium homepage. Deploy run `30651535224` attempt `1` built candidate `ca8c8130a1ec7d9b12cc14e9274fe2ba855076a1:30651535224-1` (`sha256:ed25db05618922ab271e85ff883ac965388c39d4c99eb66d38051916a56c7942`), promoted the same bytes, and produced generic/TTS live PASS artifacts; `/deployments/current.json` and the immutable manifest were independently read back against the machine envelope. AuditRepo PR #108 synchronizes `NEXT_AGENT_PROMPT`, this masthead/session log and the paired reverify; counters remain 164 closed / 192 open because no bug-class transition occurred. Evidence: `reverify/CURRENT_HEAD_REVERIFY_2026-07-31_ca8c8130_exact-production-home-closure.md`.
