...
2. **Immediate Graticule Disappearance on Zoom (`GRAT-P1-02`):**
   Coordinate tick marks vanish completely (`opacity: 0`) as soon as zoom exceeds 4%, stripping geographic context.
...
6. **Linear Unprojected Grid Equations (`GRAT-P1-01`):**
...
7. **Mechanical 20px Sea Tile Pattern (`SEA-P1-01`):**
...
8. **Primitive 3-Line Cartouche Ornaments & Magic Multipliers (`ORN-P1-01`, `CART-P1-01`, `ROSE-P1-01`):**
...
9. **Dead `halos` Array Boilerplate (`HALO-P1-01`):**
...
10. **Sequential Unbranching Catmull-Rom Spline Bowing (`ROUTE-P1-01`):**
...
11. **Glyph Data Absence Across 82% of Datasets (`GLYPH-P1-01`):**
...
1. **Fix Text Outline Stroke Scaling & Keep Graticules Visible (`LOD-P1-01`, `GRAT-P1-02`):**
...
4. **Upgrade Sea Patterns & Cartouche Artwork (`SEA-P1-01`, `ORN-P1-01`, `CART-P1-01`, `ROSE-P1-01`):**
