...
- Total-system immutable intake: [`incoming/gpt-5-6-total-system-audit/2026-08-05/REPORT.md`](incoming/gpt-5-6-total-system-audit/2026-08-05/REPORT.md)
- Previous Playwright closure: [`verified/PLAYWRIGHT_RUNTIME_LOCK_2026-08-05.md`](verified/PLAYWRIGHT_RUNTIME_LOCK_2026-08-05.md)
...
- `working/` — current synthesis, matrix, wave plan and branch disposition
...
This project remains `active`. Change it to `reverify-needed` when source main moves beyond the pinned SHA in a way that touches verified surfaces or when a verified gate becomes red.
