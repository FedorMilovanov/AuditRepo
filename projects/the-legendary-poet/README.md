...
- На current source остаются активные engineering roots в production community abuse activation, runtime accessibility focus/motion/status semantics, discovery metadata, reading-progress boundaries, authoring release contract, audit harness, audio session/release/completion integrity, analytics consent/route state, rating source/method/URL authority, production legacy-route hosting, primary/secondary data containment, global search authority, Home initial-media delivery и persistent shell visual ownership. Их единственная рабочая очередь — [`verified/MASTER_BUG_MATRIX.md`](verified/MASTER_BUG_MATRIX.md), который и владеет текущим счётчиком строк; этот README его намеренно не дублирует.
- Theme/contrast wave 2026-08-20 (Product #426) и reader-text wave 2026-08-24 (Product #427) закрыли `TLP-THEME-001`, `TLP-A11Y-CONTRAST-001` и `TLP-READER-TEXT-001` с постоянными guard'ами `qa/theme-contrast.spec.mjs` и `qa/reader-text.spec.mjs`. Компактные результаты — в [`verified/CLOSURE_LEDGER.md`](verified/CLOSURE_LEDGER.md).
...
- Theme/contrast closure: [`verification/2026-08-20-theme-contrast-closure/REPORT.md`](verification/2026-08-20-theme-contrast-closure/REPORT.md)
- Reader-text closure: [`verification/2026-08-24-reader-text-closure/REPORT.md`](verification/2026-08-24-reader-text-closure/REPORT.md)
- Matrix/SSOT integrity audit: [`verification/2026-09-06-ssot-matrix-integrity-audit/REPORT.md`](verification/2026-09-06-ssot-matrix-integrity-audit/REPORT.md)
