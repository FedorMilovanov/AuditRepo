...
**Latest current verification:** `../reverify/REVERIFY_c7e3e3b_2026-09-13_analytics-property-closure.md`.  
...
No active P2 row remains after terminal GA4 stream/collector proof.
...
- GA4 property/stream ownership and live collection are now terminally proved: property `547331637`, stream `Poet` (`15336366137`), Measurement ID `G-6NT4248RKK`, with production `page_view` accepted by Google's collector (HTTP 204).
