...
**Current production after W0 + discovery/Safari + W1:** `e06bdfc42ada0a6111f0cde6e39dd7f48204f2c8`.
...
| TLP-DISC-001 | P1 | fixed-current | CI proved regenerated sitemap/feed idempotence but did not prove committed files matched canonical data. | Inter-wave / source #305 | byte-level committed artifact validator in `check:content`; production `44a36bd`, retained in `e06bdfc` |
...
- Closed source #286, #302, #303, #305 and #308 waves remain separately attributable even when a later production SHA contains all repairs.
